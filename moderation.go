...
func (oauth2 *OAuth2) getBannedEvents(broadcasterID string, optionalParams map[string]interface{}) (*GetBannedEventsJSON, error) {
...
func (oauth2 *OAuth2) getBannedUsers(broadcasterID string, optionalParams map[string]interface{}) (*GetBannedUsersJSON, error) {
...
func (oauth2 *OAuth2) getMods(broadcasterID string, optionalParams map[string]interface{}) (*GetModsJSON, error) {
...
func (oauth2 *OAuth2) getModEvents(broadcasterID string, optionalParams map[string]interface{}) (*GetModEventsJSON, error) {
