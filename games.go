...
func (oauth2 *OAuth2) getTopGames(optionalParams map[string]interface{}) (*GetTopGamesJSON, error) {
...
func (oauth2 *OAuth2) getGames(ID string, name string) (*GetGamesJSON, error) {
